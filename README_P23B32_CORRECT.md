<p align="center">
  <img src="https://github.com/KnapTheBuilder/ha-joyonway-p23b32/raw/main/custom_components/joyonway_p23b32/brand/icon@2x.png" alt="Joyonway P23B32 Logo">
</p>
...
[![License](https://img.shields.io/github/license/KnapTheBuilder/ha-joyonway-p23b32?style=for-the-badge&color=blue)](https://github.com/KnapTheBuilder/ha-joyonway-p23b32/blob/main/LICENSE)
[![Original Author](https://img.shields.io/badge/Original_Author-KnapTheBuilder-orange.svg?style=for-the-badge)](https://github.com/KnapTheBuilder)
...
> Original work of Christophe Knap (KnapTheBuilder). Forks and derivatives must preserve attribution per [NOTICE.md](NOTICE.md).
...
<p align="center">
  <img src="https://github.com/KnapTheBuilder/ha-joyonway-p23b32/raw/main/docs/screenshots/dashboard.png" alt="Joyonway P23B32 Home Assistant dashboard example">
</p>
...
**2. Veille mode (winter holding setpoint at 30 degrees)**

Lowers the spa setpoint to 30 degrees during the night to save energy while keeping it ready for the morning.

```yaml
# 2026-05-16 | Automation | Night setpoint to 30C | Depends on: number.joyonway_p23b32_setpoint
...
**3. EDF Tempo aware heating (France only)**
...
**4. W610 bridge offline notification**
...
**6. Cooldown sequence (gradual setpoint reduction)**
...
<details>
<summary>Click to expand the reverse-engineered protocol</summary>
...
Any redistribution, fork, or derivative work of this software MUST preserve the [NOTICE.md](NOTICE.md) file and the copyright headers in source files. See NOTICE.md for full attribution requirements.

---

## License

This project is released under the [MIT License](https://github.com/KnapTheBuilder/ha-joyonway-p23b32/blob/main/LICENSE).
