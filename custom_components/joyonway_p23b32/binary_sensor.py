...
# 2026-06-07 | v0.3.2 | Ajout entite Ozone (octet 14 bit 0x80) + chauffage fiabilise
#   (le bit chauffage est desormais 0x04 = chauffe reelle cote rs485.py, plus la demande 0x10)
...
BS = [
    ...
    ("ozone", "Ozone", "mdi:atom-variant", None),
]
