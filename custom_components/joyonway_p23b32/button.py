# 2026-05-13 | Plateforme button | Expose toutes les commandes RS485 confirmees | Depend: rs485.py, __init__.py
...
# 2026-05-13 | Mapping | (cle commande, libelle UI, icone mdi) | Depend: const.py
